...
import { mergeTypeDefs, mergeResolvers } from '@graphql-tools/merge';    // Utility functions from @graphql-tools:mergeTypeDefs: Combines multiple .graphql schema files into one.mergeResolvers: Combines multiple resolver files into one.
...
import { productResolvers } from './schema/resolvers/product.resolver';   // Utility functions from @graphql-tools:mergeTypeDefs: Combines multiple .graphql schema files into one.mergeResolvers: Combines multiple resolver files into one.
...
//  Load typeDefs  {userTypeDefs,productTypeDefs} this function allows Apollo Server to load the GraphQL schema from an external 
...
const userTypeDefs = fs.readFileSync(path.join(__dirname, './schema/typeDefs/user.graphql'), 'utf-8');          
const productTypeDefs = fs.readFileSync(path.join(__dirname, './schema/typeDefs/product.graphql'), 'utf-8');
